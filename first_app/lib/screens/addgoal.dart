                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            MaterialButton(
                              minWidth: 40,
                              onPressed: (){
                                if ((_textformfield_categoryName.currentState!.validate()) && (_textformfield_targetHours.currentState!.validate())
                                && (_textformfield_cover.currentState!.validate()) && (_textformfield_categoryDescription.currentState!.validate())) {
                            ...
                            MaterialButton(
                              ...
                              onPressed: (){
                                if ((_textformfield_goalName.currentState!.validate()) &&
                                 (_textformfield_frequency.currentState!.validate()) &&
                                 (_textformfield_times.currentState!.validate()) &&
                                 (_textformfield_duration.currentState!.validate()) &&
                                 (_textformfield_goalDescription.currentState!.validate())){
